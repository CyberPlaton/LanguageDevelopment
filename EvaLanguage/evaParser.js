...
[/^"[^\"]*"/, function() { return 'STRING'			/*Define String as "something in between double quotes"*/ }],
[/^\d+/, function() { return 'NUMBER'			/*Define Number as any decimal values*/ }],
[/^[\w\-+*=<>/]+/, function() { return 'SYMBOL' 		/*Define Symbol as any of the given*/ }]];
